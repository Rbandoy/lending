...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('Main');?>">
  ...
  <div class="sidebar-brand-text mx-3">Coins Savings Capital <sup>App</sup></div>
</a>
...
<li class="nav-item">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <h6 class="collapse-header">Acocunt Settings:</h6> 
        <a class="collapse-item" href="<?php echo base_url('admin');?>">Admin</a> 
      <!-- <a class="collapse-item" href="cards.html">Borrower</a> -->
    </div>
  </div>
</li>
